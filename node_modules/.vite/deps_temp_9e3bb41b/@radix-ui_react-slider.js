...
import {
  usePrevious,
  useSize
} from "./chunk-GL7NF2JX.js";
import {
  createContextScope,
  useControllableState
} from "./chunk-2PHHCEAG.js";
import {
  require_react_dom
...
var Slider = React6.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React6.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React6.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React6.useRef(values);
...
var SliderHorizontal = React6.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
    ...
    const [slider, setSlider] = React6.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React6.useRef(void 0);
...
var SliderVertical = React6.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
...
var SliderImpl = React6.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React6.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React6.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React6.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection(props.__scopeSlider);
    const [thumb, setThumb] = React6.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index = React6.useMemo(
...
var SliderThumbImpl = React6.forwardRef(
  (props, forwardedRef) => {
