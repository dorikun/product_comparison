...
import {
  useSize
} from "./chunk-INMYUXCG.js";
import {
  useControllableState
} from "./chunk-BLNAQ2OF.js";
import {
  createContextScope
...
var Slider = React5.forwardRef(
  (props, forwardedRef) => {
    ...
    const thumbRefs = React5.useRef(/* @__PURE__ */ new Set());
    const valueIndexToChangeRef = React5.useRef(0);
    ...
    const valuesBeforeSlideStartRef = React5.useRef(values);
...
var SliderHorizontal = React5.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
    ...
    const [slider, setSlider] = React5.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setSlider(node));
    const rectRef = React5.useRef(void 0);
...
var SliderVertical = React5.forwardRef(
  (props, forwardedRef) => {
    const {
      min,
      max,
...
var SliderImpl = React5.forwardRef(
  (props, forwardedRef) => {
    const {
      __scopeSlider,
      onSlideStart,
...
var SliderTrack = React5.forwardRef(
  (props, forwardedRef) => {
...
var SliderRange = React5.forwardRef(
  (props, forwardedRef) => {
...
var SliderThumb = React5.forwardRef(
  (props, forwardedRef) => {
    const getItems = useCollection(props.__scopeSlider);
    const [thumb, setThumb] = React5.useState(null);
    const composedRefs = useComposedRefs(forwardedRef, (node) => setThumb(node));
    const index = React5.useMemo(
...
var SliderThumbImpl = React5.forwardRef(
  (props, forwardedRef) => {
...
var BubbleInput = (props) => {
  ...
  return (0, import_jsx_runtime4.jsx)("input", { style: { display: "none" }, ...inputProps, ref, defaultValue: value });
};
